...
int main(){
	  ...
	  std::string filePath_NonB =
    "/work/ws-tmp/gt044374-charge_tagger_2/Andreas_files/ChargePairing/btagscore/JetBtagDeepFlavB_NonB_Distributions.root";

          std::string filePath_B ="/work/ws-tmp/gt044374-charge_tagger_2/Andreas_files/ChargePairing/btagscore/JetBtagDeepFlavB_B_Distributions.root";
